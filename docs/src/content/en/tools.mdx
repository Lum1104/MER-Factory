...
### Prompt Configuration & CLI running
...
*Note: The preview functionality for videos/images is for demonstration purposes only. Please clone the repository locally and run `dashboard.py` to use.*
...
1. **Open the Dashboard**: Launch the dashboard from your local installation
