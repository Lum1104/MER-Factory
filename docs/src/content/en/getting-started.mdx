...
<Callout type="info">
**Note:** After building OpenFace, please note down the path to the `FeatureExtraction` executable (usually in `build/bin/FeatureExtraction`). You will need it during configuration.
</Callout>
...
- **[Technical Documentation](/docs/technical-docs)** - System architecture details
...
- Read the [Technical Documentation](/docs/technical-docs) for deeper understanding
